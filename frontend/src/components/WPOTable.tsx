...
const WPOTable: React.FC = () => {
    ...
    const filteredRows = withoutPOData.filter((row) => {
        // Text search filter
        if (search) {
    ...
    const renderCellContent = (
        row: (typeof withoutPOData)[number],
        col: typeof prColumns[number]
    ) => {
        ...
        <div className="outstanding-pr-root">
            ...
            <main className="outstanding-pr-content">
                <header className="outstanding-pr-header">
                    <h1 className="outstanding-pr-title">Without Purchase Order</h1>
                    <p className="outstanding-pr-subtitle">
                        View and search purchase requests without a purchase order. Use the filters
