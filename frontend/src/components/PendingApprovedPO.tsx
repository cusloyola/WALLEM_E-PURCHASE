...
const PendingApprovedPO: React.FC = () => {
    ...
    const [dateTo, setDateTo] = useState("2027-02-02"); // Extended to include 2026 dates

    const filteredRows = pendApprData.filter((row) => {
        // Text search filter
        if (search) {
        ...
        <div className="outstanding-pr-root">
            ...
            <main className="outstanding-pr-content">
                <header className="outstanding-pr-header">
                    <h1 className="outstanding-pr-title">Pending/Approved Purchase Orders</h1>
                    <p className="outstanding-pr-subtitle">
                        View and search pending and approved purchase orders. Use the filters
                    ...
                    <table className="outstanding-pr-table">
                        ...
                        <tbody>
                            {paginatedRows.length === 0 ? (
                                <tr>
                                    <td
                                        colSpan={pendApprColumns.length}
...
export default PendingApprovedPO;